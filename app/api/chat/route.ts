...
Використовуй D&D термінологію відповідно до глосарію:
ПЗ (Пункти здоров'я), КО (Клас обладунку), ПН (Показник небезпеки), бонус майстерності, рятівний кидок, перевага/недолік.`
